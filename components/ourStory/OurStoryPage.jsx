...
export const OurStory = () => {
    return (
      <div className="pt-11 pb-20 bg-main-background">
        ...
        <p className="text-base mb-2 text-start">У результаті, ми хочемо, щоб кожен відчував себе впевнено &quotв своїй шкірі&quot</p>
