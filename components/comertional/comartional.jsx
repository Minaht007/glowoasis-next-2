    ...
    return (
        ...
        <div className="flex flex-col h-[985px] justify-center md:h-[1224px] lg:h-[807px] lg:flex-row w-screen lg:items-center lg:relative bg-cover bg-center bg-no-repeat bg-comertional-bg layout">
                ...
                <div className="grid order-3 self-center space-y-5 md:space-y-0 md:w-[500px] md:grid md:gap-7 md:grid-cols-2 lg:space-y-0 lg:order-1 lg:absolute lg:mr-[850px] lg:mt-[280px]">
                    <button className="border flex items-center justify-center w-[240px] h-[44px] md:h-[50px] cursor-pointer bg-btn-bg-primery-color" >комбінована шкіра</button>
                    <button className="border flex items-center justify-center w-[240px] h-[44px] md:h-[50px] cursor-pointer bg-btn-bg-primery-color">суха шкіра</button>
                    <button className="border flex items-center justify-center w-[240px] h-[44px] md:h-[50px] cursor-pointer bg-btn-bg-primery-color">жирна шкіра</button>
                    <button className="border flex items-center justify-center w-[240px] h-[44px] md:h-[50px] cursor-pointer bg-btn-bg-primery-color">чутлива шкіра</button>
                </div>
